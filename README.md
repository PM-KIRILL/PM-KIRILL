...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ae,androidstudio,arduino,atom,au,aws,blender,bootstrap,cloudflare,css,discord,bots,django,figma,flask,git,github,githubactions,go,heroku,html,idea,js,jquery,linux,md,mongodb,mysql,nodejs,ps,php,postgres,postman,pr,py,react,replit,svg,ts,vercel,vscode,vue,xd&perline=10" />
  </a>
</p>
### Connect with me:
